...
| :--- | :--- | :--- |
| 1 | [Вступ](./Project/Section_01.md) | Мета та актуальність автоматизації бібліотеки. |
| 2 | [Стек технологій](./Project/Section_02.md) | Налаштування `.env`, Node.js, React та PostgreSQL. |
| 3 | [Об'єкт аналізу](./Project/Section_03.md) | Опис структури бібліотечного фонду та процесів. |
| 4 | [Проблематика](./Project/Section_04.md) | Аналіз недоліків паперового обліку книг. |
| 5 | [Вимоги до системи](./Project/Section_05.md) | Функціональні та технічні вимоги до ПЗ. |
| 6 | [Архітектура](./Project/Section_06.md) | **Діаграма компонентів та server.js**. |
| 7 | [Модель даних](./Project/Section_07.md) | **SQL-схема та ER-діаграма (PostgreSQL)**. |
| 8 | [Вибір СКБД](./Project/Section_08.md) | Обґрунтування PostgreSQL та логіка зв'язків. |
| 9 | [Алгоритми](./Project/Section_09.md) | Логіка обробки видач та повернення книг. |
...
Повна пояснювальна записка (40 сторінок), що включає всі 16 розділів системного аналізу, UML-діаграми та описи архітектури:

* [📕 Завантажити Пояснювальну записку (PDF)](./Documentation/Практична%2010.pdf)
* [📘 Завантажити Пояснювальну записку (DOCX)](./Documentation/Практична%2010.docx)